    ...
    <div className="mt-10">
      ...
      <div className="mb-8 text-center">
        <div 
          ...
          style={{ backgroundColor: withAlpha(ACTIVE_THEME.accent, 0.1) }}
        >
          <span className="text-xs font-semibold uppercase tracking-wider" style={{ color: ACTIVE_THEME.accent }}>
            IPHIPI TECHNOLOGY
          </span>
        </div>
        <h2 className="mt-3 text-2xl font-bold tracking-tight md:text-3xl" style={{ color: ACTIVE_THEME.secondary }}>
          Next-Generation Speech Enhancement
        </h2>
        <p className="mt-1 text-sm" style={{ color: ACTIVE_THEME.bodyText }}>
          Intelligent audio processing for real-world environments
        </p>
      </div>

      {/* Feature Grid - Secondary background with white text */}
      <div className="grid gap-4 md:grid-cols-2">
        {items.map((item, index) => (
          <div
            ...
            style={{ 
              backgroundColor: ACTIVE_THEME.secondary,
              borderColor: withAlpha('#ffffff', 0.1),
            }}
          >
            <div
              className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg"
              style={{ backgroundColor: withAlpha('#ffffff', 0.12), color: '#ffffff' }}
            >
              {item.icon}
            </div>
            <div className="flex-1 min-w-0">
              <span className="text-[10px] font-semibold uppercase tracking-wider" style={{ color: withAlpha('#ffffff', 0.6) }}>
                Feature 0{index + 1}
              </span>
...
//       <div className="mt-10 flex flex-col gap-6">
//         {/* Removed the first image (dsp-flow.png) */}
...
//       <Image 
//         src="/tech/single-mic/ai-noise-suppression-flow.png" 
//         alt="AI Noise Suppression Flow diagram" 
//         fill
//         style={{ objectFit: 'contain' }} // Use 'cover' if you want it to crop to fill
//       />
//     </div>
    ...
    <div className="mt-16">
      ...
      <div className="mt-8 flex flex-col gap-6">
        <div className="overflow-hidden rounded-2xl">
          <div className="grid md:grid-cols-2">
            <div className="p-6 sm:p-8 md:p-10">
              <p className="text-xs font-semibold uppercase tracking-wide" style={{ color: ACTIVE_THEME.bodyText }}>
                Interfering-Talker Suppression
              </p>
              <p className="mt-1 text-sm font-medium" style={{ color: ACTIVE_THEME.secondary }}>
                Preserve the wearer. Reject surrounding conversations.
              </p>
              <p className="mt-5 text-sm leading-relaxed" style={{ color: ACTIVE_THEME.bodyText }}>
                Unlike traffic, wind, or machinery noise, nearby conversations contain speech that
                closely resembles the wearer&apos;s voice, making them one of the most challenging
                noise sources to suppress. In offices, homes, cafés, contact centres, and shared
                workspaces, multiple people often speak simultaneously. IPHIPI&apos;s dual-microphone
        ...
        <div className="overflow-hidden rounded-2xl">
          <div className="grid md:grid-cols-2">
            <div className="p-6 sm:p-8 md:p-10">
              ...
              <p className="mt-3 text-sm leading-relaxed" style={{ color: ACTIVE_THEME.bodyText }}>
                Drive-thru communication takes place amid engines, traffic, wind, fans, music,
                and overlapping conversations—conditions that directly affect order accuracy, speed
                of service, and crew confidence. IPHIPI&apos;s far-field ENC and speech enhancement
                isolates the customer&apos;s voice from continuously changing lane noise and improves
  ...
  return (
    <div className="mt-16">
      ...
      <div className="mt-8 flex flex-col gap-6">
        <div className="overflow-hidden rounded-2xl">
          <div className="grid md:grid-cols-2">
            <div className="p-6 sm:p-8 md:p-10">
              ...
              <p className="mt-1 text-sm font-semibold" style={{ color: ACTIVE_THEME.secondary }}>
                Immediate control without cloud processing
              </p>
              <p className="mt-2 text-sm leading-relaxed" style={{ color: ACTIVE_THEME.bodyText }}>
                Keyword spotting enables commonly used actions to be triggered through short,
                natural voice commands. The model continuously listens only for the configured
                command set, allowing devices to respond quickly without streaming audio to the
                cloud or running a complete ASR pipeline.
        ...
        <div className="rounded-2xl border p-6 sm:p-8" style={{ borderColor: withAlpha(ACTIVE_THEME.bodyText, 0.2) }}>
          <p className="text-xs font-semibold uppercase tracking-wide" style={{ color: ACTIVE_THEME.bodyText }}>
          ...
          <p className="mt-2 max-w-2xl text-sm leading-relaxed" style={{ color: ACTIVE_THEME.bodyText }}>
            IPHIPI&apos;s keyword-spotting technology can be adapted to different products and
            brand identities. Using the brand&apos;s preferred wake phrase and representative
            speech data, the KWS model can be fine-tuned to recognize custom wake words and
            commands while maintaining low-power, on-device operation. This enables brands to
