  ...
  return (
    <main className="flex-1 pb-28 transition-colors duration-500" style={{ backgroundColor: theme.pageBg }}>
      <TechSubpageHero
        ...
        tagline="Business voice interfaces often operate where the speaker is not close to the microphone. IPHIPI's far-field speech enhancement isolates speech from surrounding noise for drive-thrus, kiosks, and smart home devices."
        current="Far-Field"
      />
